...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__011Par MockUpRev.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function runCode(app) {
    ...
    /***  placa  ***/
    const titlePlaca = 'Placa de fibrosilicato';
    const urlPlacaPDF = '/wp-content/uploads/2021/10/FT-PROMATECT-H-.pdf';
    const imgPlaca = '/wp-content/uploads/2021/10/placa-silicato.png';
    const textPlaca = `Placa de silicato cálcico de gran formato, incombustible,
    autoportante,monolítica y estable dimensionalmente.`;
