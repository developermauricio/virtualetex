...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__088Par MockUpRev.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function runCode(app) {
    /*  Elements */
	const placaAnotation = document.getElementById("placa");
	const fibraAnotation = document.getElementById("fibra");
	
	let contentPopupPlaca = document.getElementById("contentPopup"); 
	let contentPopupFibra = document.getElementById("contentPopupFibra"); 
	
	const closePopupPlaca = document.getElementById("closePopup");
	const closePopupFibra = document.getElementById("closePopupFibra");


    /*  variables  */
	let placa = false, fibra = false;
	...
	const openMuroPopup = () => { 
		statePopup();
		contentPopupPlaca.style.display = "block"; 
		placa = true;
	}	
	const openFibraPopup = () => { 
		statePopup();
		contentPopupFibra.style.display = "block"; 
		fibra = true;
	}	
	
	
	const closeMuroPopup = () => {	
		contentPopupPlaca.style.display = "none";  
		placa = false;
	}
	const closeFibraPopup = () => {	
		contentPopupFibra.style.display = "none";  
		fibra = false;
	}
	...
	/*  Events clicks  */	
	placaAnotation.addEventListener("click", openMuroPopup, false);	
	fibraAnotation.addEventListener("click", openFibraPopup, false);
	
	contentPopupPlaca.addEventListener("click", closeMuroPopup, false);
	closePopupFibra.addEventListener("click", closeFibraPopup, false);
