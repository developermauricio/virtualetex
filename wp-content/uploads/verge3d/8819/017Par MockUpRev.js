...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__017Par MockUpRev.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function runCode(app) {
    ...
    /***  placa  ***/
    const titlePlaca = 'PLACA RH Resistente a la humedad';
    const urlPlacaPDF = '/wp-content/uploads/2021/10/FT-Gyplac-Placa-Resistente-a-la-humedad.pdf';
    const imgPlaca = '/wp-content/uploads/2021/10/placa-humedad.png';
    const textPlaca = `Placa compuesta por un núcleo de roca de yeso y aditivos,
    que proveen protección adicional contra la humedad en
    comparación con las placas de yeso estándar. Las caras
    de las placas son revestidas con varias capas de papel de
    celulosa especial, 100 % reciclado. Estas son fabricadas
